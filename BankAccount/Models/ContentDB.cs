...
namespace BankAccount.Models
{
    public class ContentDB: DropCreateDatabaseAlways<BankaccountContext>
    {
        protected override void Seed(BankaccountContext db)
        {
            ...
            db.Accounts.Add(new Account { Name = "MyAccount", CurrencyId = 1, Money = 5999.23, NumberAccount = 668581 });
            db.Users.Add(new User { Name = "John Smith", Login = "Admin", Password = "Admin", Email = "user@gmail.com", Address = "New Vasuki", Phone = "55-44-33", Passport = "KK556622", INN = 585099, Bday = new DateTime(1983, 10, 05), DateRegistration = DateTime.Now, AccountId = 1 });
            base.Seed(db); 
        }
    }
}